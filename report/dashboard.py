...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        print(f"DataFrame received from model.events_counts: {df}")
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        #set xticks to make barh plot more readable
...
class NotesTable(DataTable):
    ...
    #### YOUR CODE HERE
    def component_data(self, entity_id, predictor):
        
        # Using the model and entity_id arguments
        # pass the entity_id to the model's .notes 
        # method. Return the output
        #### YOUR CODE HERE
        return predictor.notes(entity_id)
